//! Burn backend integration tests

use injection_core::detect;

#[test]
#[cfg(feature = "backend-burn")]
fn test_burn_injection_detection() -> anyhow::Result<()> {
    println!("Testing Burn backend with CUDA...\n");
...
#[test]
#[cfg(feature = "backend-burn")]
fn test_burn_benign_text() -> anyhow::Result<()> {
    // Test benign text
...
#[test]
#[cfg(feature = "backend-burn")]
fn test_burn_multiple_inputs() -> anyhow::Result<()> {
    let test_cases = vec![
